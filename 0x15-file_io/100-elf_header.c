 ...
 * @e_ident: The pointer of an array containing the ELF magic numbers.
...
/**
 * print_class - Prints the class in the ELF header.
 * @e_ident: The pointer of an array containing ELF class.
 */
void print_class(unsigned char *e_ident)
{
	printf(" Class: ");
...
/**
 * print_data - Prints the data in the ELF header.
 ...
 * @e_ident: The pointer of an array containing the ELF version.
 */
void print_version(unsigned char *e_ident)
{
	 printf(" Version: %d",
...
/**
 * print_abi - Prints the ABI version in the ELF header.
 * @e_ident: The pointer of an array containing ELF ABI version.
 */
void print_abi(unsigned char *e_ident)
{
...
/**
 * print_entry - Prints the entry point in the ELF header.
 ...
 * @argc: The number of arguments to  supply in the program.
 * @argv: The array of pointers in the arguments.
 * Return: 0 if success.
